databaseChangeLog = {
	...
	changeSet(author: "Admin (generated)", id: "1421868389631-1") {
	...
	changeSet(author: "Admin (generated)", id: "1421868389631-2") {
	...
	changeSet(author: "Admin (generated)", id: "1421868389631-3") {
	...
	changeSet(author: "Admin (generated)", id: "1421868389631-4") {
	...
	changeSet(author: "Admin (generated)", id: "1421868389631-5") {
	...
	changeSet(author: "Admin (generated)", id: "1421868389631-9") {
		createIndex(indexName: "FK_bbyw97opl7hms8p7rpdqr9iy6", tableName: "intent") {
			column(name: "city_id")
		}
	}

	changeSet(author: "Admin (generated)", id: "1421868389631-10") {
		createIndex(indexName: "FK_95ctvhkyhf9mw155s56e4aior", tableName: "route") {
			column(name: "departure_city_id")
		}
	}

	changeSet(author: "Admin (generated)", id: "1421868389631-11") {
		createIndex(indexName: "FK_puqsojmyhppxovvj9g3q21204", tableName: "route") {
			column(name: "destination_city_id")
		}
	}

	changeSet(author: "Admin (generated)", id: "1421868389631-12") {
		createIndex(indexName: "param_key_uniq_1421868389568", tableName: "settings", unique: "true") {
			column(name: "param_key")
		}
	}

	changeSet(author: "Admin (generated)", id: "1421868389631-6") {
	...
	changeSet(author: "Admin (generated)", id: "1421868389631-7") {
	...
	changeSet(author: "Admin (generated)", id: "1421868389631-8") {
