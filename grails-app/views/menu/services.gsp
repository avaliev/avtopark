...
<head>
    ...
    <meta name="keywords"
          content="грузоперевозки по России цены, грузоперевозки по России газелью, грузоперевозки по России бычок">
    <meta name="description"
          content="Мы осуществляем грузоперевозки по городам России оптимальным маршрутом. Грузоперевозки по России возможны с участием как отдельного транспорта, так и с помощью догруза, возможна перевозка сборных грузов.">
    <title>Предоставляем услуги по грузоперевозке, газель, бычок, фура. От 50кг до 20т.</title>
</head>
...
<section class="hgroup centered">
    ...
    <h2>Здесь представлена инфорация по нашим <strong>услугам грузоперевозок</strong>.
    </h2>
    ...
    <div class="service_teaser">
        <div class="row">
            ...
            <div class="service_details col-sm-8 col-md-8">
                ...
                <a class="btn btn-success pull-right" href="/menu/request">Заказать Газель</a>
            </div>
        </div>
    </div>
    ...
    <div class="service_teaser">
        <div class="row">
            ...
            <div class="service_details col-sm-8 col-md-8">
                ...
                <a class="btn btn-success pull-right" href="/menu/request">Заказать "Бычок"</a>
            </div>
    ...
    <div class="service_teaser right">
        <div class="row">
            ...
            <div class="service_details col-sm-8 col-md-8">
                ...
                <a class="btn btn-success pull-right" href="/menu/request">Заказать Камаз</a>
            </div>
        </div>
    </div>
    ...
    <div class="service_teaser right">
        <div class="row">
            <div class="service_details col-sm-8 col-md-8t">
                ...
                <a class="btn btn-success pull-right" href="/menu/request">Заказать Фуру</a>
            </div>
