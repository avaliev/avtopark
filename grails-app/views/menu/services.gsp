            ...
            <div class="service_teaser">
                <div class="row">
                    ...
                    <div class="service_details col-sm-8 col-md-8">
                        ...
                        <a class="btn btn-danger pull-right" href="/menu/request">Заказать Газель</a>
                    </div>
                </div>
            </div>
            ...
            <div class="service_teaser">
                <div class="row">
                    ...
                    <div class="service_details col-sm-8 col-md-8">
                        ...
                        <a class="btn btn-danger pull-right" href="/menu/request">Заказать "Бычок"</a>
                    </div>
            ...
            <div class="service_teaser right">
                <div class="row">
                    ...
                    <div class="service_details col-sm-8 col-md-8">
                        ...
                        <a class="btn btn-danger pull-right" href="/menu/request">Заказать Камаз</a>
                    </div>
                </div>
            </div>
            ...
            <div class="service_teaser right">
                <div class="row">
                    <div class="service_details col-sm-8 col-md-8t">
                        ...
                        <a class="btn btn-danger pull-right" href="/menu/request">Заказать Фуру</a>
                    </div>
