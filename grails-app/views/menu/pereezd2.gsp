...
<h3 class="txt-c">Осуществляем офисные переезды любой город России и СНГ</h3>
...
<div class="row">
    ...
    <div class="col-xs-3">
        <input style="display: none" id="user_name" class="form-control" name="userName" value="<офисный переезд>" type="text" />
