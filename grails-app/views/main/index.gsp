    ...
    <div class="row">
        ...
        <div class="col-lg-7 col-md-9 col-sm-9 col-xs-7">
            ...
            <ul>
                ...
                <li><b/>Фура</strong>   для больших и габаритных грузов (до 20 тонн) - гарантия сохранности ваших грузов;
                </li>
                <li><b/>Камаз</strong> - надежная и быстрая машина для грузоперевозок до 10 тонн;</li>
                <li><b/>Бычок</strong> - маневренная и неприхотливая машина для самых разных видов товаров и продукции;</li>
                <li><b/>Рефрижератор</strong> – предназначен для перевозки скоропортящихся грузов, требующих соблюдения определенной температуры.
                </li>
                <li><b/>Контейнеровоз </strong> - так же можно заказать по всей России.</li>
            </ul>
