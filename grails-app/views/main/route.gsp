...
<body>
    <div class="row">
        ...
        <div class="col-xs-7">
            ...
            Благодаря всему этому компанию «Авто-парк» выбирают за то, что она может удовлетворить все требования и пожелания своих Клиентов, которые хотят быть уверены в надежности доставки груза. Мы гарантируем выполнение всех условий, заранее оговоренных в составленном и подписанном договоре. Можете быть уверены в том, что любые грузоперевозки по России, совершаемые компанией «Авто-парк», будут произведены с максимальной внимательностью и ответственностью.
            </p>
            <g:render template="/shared/calculator"></g:render>
            <h4>Перевозка догрузом – выгодное решение по минимальной цене</h4>
            <p class="descr">Каждый день по территории Российской Федерации перемещаются сотни грузовых автомобилей с неполной загрузкой. В таком транспорте остается достаточно места для того, чтобы взять дополнительный малогабаритный груз.
            Менеджеры нашей компании готовы подобрать для вас такой автомобиль с учетом необходимого для вас направления. Важно отметить, что в данном случае вы заплатите намного меньше, чем при заказе отдельного автомобиля.
