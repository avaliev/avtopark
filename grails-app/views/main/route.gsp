...
<div class="jumbotron">
    ...
    <div class="row">
        ...
        <div class="col-md-7 col-sm-9 center-content">
            ...
            <p class="descr">Вы ищете надежную компанию, которая осуществляет грузоперевозки в городе Казань?

            Мы являемся одними из лидеров в данной области не только в Казани, но и далеко за ее границами.
