...
<div class="row">
    <div class=" col-md-9">
        ...
        <p class="descr">
            ...
            Чтобы транспортировка грузов не стала хлопотливым и обременительным делом, необходима заблаговременная разработка оптимального и выгодного маршрута, по которому будут осуществлены перевозки, определена наиболее эффективная схема транспортировки.
        ...
        <p class="descr">Для нашей большой страны грузовые перевозки, пожалуй, являются насущной и важной задачей.
        ...
        <h4>Перевозки отдельным транспортом</h4>
        ...
        <h4>Доставка догрузом и сборным грузом</h4>
        ...
        <p class="descr">
            ...
            особенности транспортировки различных объектов,
